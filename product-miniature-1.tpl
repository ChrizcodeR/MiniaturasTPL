    ...
    {block name='product_price_and_shipping'}
        ...
        {if $product.show_price}
            ...
            <div class="product-price-and-shipping">
                ...
                <span  class="product_price_and_shipping">
                <p style="color: #ca1a32;";><span>ADDI 10%Dto Exclusivo día sin IVA</span></p>
                <p style="color: #8ac841; text-align: center;";><span>*El descuento es una accion comercial de ADDI Aplc T&C</span></p>
                <table width="auto" height="auto" style="width: auto; height: auto; margin-left: auto; margin-right: auto; float: center; font-size: 12px;">
                <tbody>
                <tr>
                <td><img src="https://cascoloco.com/iconos/addi.png" width="30" height="30" /></td>
                <td>
                <p style="color: #8ac841; text-align: left;";><span>Exclusivo para día sin IVA</span> </p>
                </td>
                </tr>
                </tbody>
                </table>
